...
1. **M3 — Stage 1 presentation:** replace remaining placeholder animation/audio/UI coverage with vertical-slice quality assets and flow.
...
- Stage 1 now has independent final-direction background art for all three scenes, but still needs foreground parallax/animation, complete fighter state animation, original music, and final stage-clear presentation.
- No music, character selection, multiplayer, vehicle, continue countdown, or high-score persistence exists yet; the three-family Stage 1 weapon set is only the foundation of the final weapon sandbox.
