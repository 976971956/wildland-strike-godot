...
- [ ] Teammate revive/continue and team attack.
...
1. **M4 — Co-op combat loop:** implement teammate revive/continue and team attack, then run all solo and 2–3 player Stage 1 combinations to close the M4 exit gate.
