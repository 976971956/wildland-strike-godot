...
Current release state: seven-stage playable alpha
...
1. **M7 — Laboratory finale Stage 8:** build three original laboratory/finale scenes, an elite gauntlet, systemic containment hazards, a genuinely multi-form final boss, Stage 7→8 transition, eight-node route expansion, ending and credits while preserving every completed M0–M7 gate.
...
- The reusable human/dinosaur roster is complete through M5; Stages 1–7 have unique boss encounters and composition, while Stage 8 still requires its final boss.
- Stages 1–7 are completed release-quality campaign content; subsequent milestones must preserve their combat, presentation, Web performance, and acceptance standards while completing the finale and arcade shell.
- Character selection, typed role tuning, complete original 24-state sheets, three-slot local device routing, independent ready states, safe spawning, shared-camera framing, faction-safe combat, stage-and-player-count spawn scaling, teammate rescue, per-player continues, linked team attacks, seven-node campaign mapping, score/life settlement, and the complete fourteen-run M4 acceptance matrix exist for all four heroes. Their timing contract remains shared until later role-balance passes. Local high-score persistence does not exist yet. The twelve-behavior weapon catalog, Stage 1 carryable/breakable/hazard and typed pickup distribution, Stage 2 systemic currents, Stage 5 fire/smoke/water-pressure hazards, Stage 6 spore/cart/stomp hazards, Stage 7 deck/laser/cryo hazards, four-species ecology, six standard enemies, four elites, and reusable encounter recipes are complete.
