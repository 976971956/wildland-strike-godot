...
1. **M6 — First-half campaign flow:** add a stage map/title route, explicit difficulty progression, persistent score/lives settlement, completion bonuses, and deterministic four-stage start-to-finish acceptance while preserving every completed M0–M6 gate.
