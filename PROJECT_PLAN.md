...
- [ ] Per-player selection/HUD, collision ownership, scaling, revive/continue, and team attack.
...
1. **M4 — Co-op combat loop:** add per-player selection/HUD, collision ownership, scaling, revive/continue, and team attack, then close the M4 exit gate.
