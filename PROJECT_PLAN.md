...
1. **M2-07 — Impact tuning:** tune hit stop, recoil, layered SFX, camera response, and haptics from frame data.
2. **M3 — Stage foundation:** introduce typed stage/scene data and the encounter director.
3. **M3 — Stage 1 encounters:** build distinct lock zones, transitions, hazards, breakables, and drops.
