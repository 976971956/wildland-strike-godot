...
const PROFILES := {
	...
	&"knife_slash": [360.0, 0.06, 2.45, 0.34, 0.5, -8.0, 4, -2.0, 0.07],
	&"shield_block": [118.0, 0.095, 2.8, 0.42, 0.28, -5.0, 6, -4.0, 0.1],
	&"shield_break": [72.0, 0.2, 2.1, 0.78, 0.62, -2.0, 8, -7.0, 0.22],
	&"elite_armor": [92.0, 0.13, 1.68, 0.58, 0.38, -4.0, 6, -4.5, 0.12],
	&"dinosaur_wake": [174.0, 0.22, 1.34, 0.38, 0.24, -6.0, 5, -3.0, 0.14],
	&"dinosaur_enrage": [88.0, 0.34, 1.82, 0.62, 0.48, -2.5, 7, -7.0, 0.28],
	&"voice_hero": [196.0, 0.20, 1.18, 0.24, -0.36, -3.0, 7, -5.0, 0.16],
	&"voice_boss": [104.0, 0.28, 1.42, 0.34, 0.24, -2.0, 7, -6.0, 0.20],
	&"voice_creature": [72.0, 0.32, 1.86, 0.56, 0.44, -1.5, 7, -6.5, 0.22],
	&"water_surge": [84.0, 0.28, 1.22, 0.92, 0.18, -2.5, 7, -6.5, 0.2],
	&"rush": [146.0, 0.16, 1.64, 0.62, 0.52, -4.0, 6, -5.0, 0.14],
	&"vehicle_ram": [68.0, 0.19, 1.74, 0.88, 0.64, -1.5, 8, -8.0, 0.22],
	&"vehicle_crash": [48.0, 0.27, 2.18, 0.96, 0.72, -0.5, 8, -10.0, 0.28],
	&"road_mine": [58.0, 0.23, 1.88, 0.94, 0.68, -1.0, 8, -9.0, 0.24],
	&"industrial_impact": [64.0, 0.18, 2.42, 0.86, 0.58, -2.0, 7, -7.0, 0.18],
	&"magnet_pull": [330.0, 0.3, 0.54, 0.44, -0.62, -2.0, 7, -7.0, 0.24],
	&"furnace_blast": [76.0, 0.3, 1.86, 0.92, 0.26, -1.0, 8, -9.0, 0.26],
