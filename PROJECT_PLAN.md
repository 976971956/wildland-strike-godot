...
1. **M3 — Stage 1 presentation:** add foreground scene motion and complete state-specific fighter/enemy animation coverage, then finish the remaining SFX/UI polish.
...
- Stage 1 now has independent final-direction background art, original state-driven music, and a complete staged score settlement, but still needs foreground parallax/animation and complete fighter/enemy state animation.
